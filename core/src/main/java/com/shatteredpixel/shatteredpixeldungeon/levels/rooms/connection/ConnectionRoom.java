...
public abstract class ConnectionRoom extends Room {
	...
	static {
		...
		chances[11] = new float[]{0, 0,     22, 3,      0, 0};
		chances[20] = chances[19] = chances[18] = chances[17] = chances[16] = chances[15] = chances[14] = chances[13] = chances[12] = chances[11];

		chances[21] = new float[]{12, 0,    0, 5,       5, 3};
		chances[30] = chances[29] = chances[28] = chances[27] = chances[26] = chances[25] = chances[24] = chances[23] = chances[22] = chances[21];

		chances[31] = new float[]{0, 0,     18, 3,      3, 1};
		...
		chances[42] = new float[]{15, 4,    0, 2,       3, 2};
		chances[51] = chances[50] = chances[49] = chances[48] = chances[47] = chances[46] = chances[45] = chances[44] = chances[43] = chances[42];
	}
