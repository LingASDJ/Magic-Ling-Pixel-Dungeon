...
public class DriedRose extends Artifact {
	...
	public static class GhostHero extends NPC {
		...
		public void sayAppeared(){
			int depth = (Dungeon.depth - 1) / 10;
			
			//only some lines are said on the first floor of a depth
			int variant = Dungeon.depth % 10 == 1 ? Random.IntRange(1, 3) : Random.IntRange(1, 6);
		...
		public void sayBoss(){
			...
			switch(depth){
				...
				case 1:
					...
					break;
				case 2:
					yell( Messages.get( this, "seen_slmk_" + Random.IntRange(1, 3) ));
					break;
				case 3:
