...
public class WndStory extends Window {
	...
	public static final int ID_WORLD		= 5;
	...
	static {
		...
		CHAPTERS.put( ID_WORLD, "ice" );
		CHAPTERS.put( NEW, "new" );
		CHAPTERS.put( N1, "sewersboss" );
		CHAPTERS.put( N2, "prisonsboss" );
		CHAPTERS.put( N3, "cavesboss" );
		CHAPTERS.put( N4, "citysboss" );
		CHAPTERS.put( N5, "hallsboss" );
	}
