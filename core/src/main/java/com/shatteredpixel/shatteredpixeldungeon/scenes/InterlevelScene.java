...
public class InterlevelScene extends PixelScene {
	...
	public void create() {
				...
				if (Dungeon.hero == null){
					...
					if (!(Statistics.deepestFloor < loadingDepth)) {
						fadeTime = FAST_FADE;
							...
							|| loadingDepth == 31 || loadingDepth == 41) {
						fadeTime = SLOW_FADE;
					}
				}
				scrollSpeed = 5;
		...
		if (loadingDepth <= 10)          loadingAsset = Assets.Interfaces.LOADING_SEWERS;
		else if (loadingDepth <= 20)    loadingAsset = Assets.Interfaces.LOADING_PRISON;
		else if (loadingDepth <= 30)    loadingAsset = Assets.Interfaces.LOADING_CAVES;
		else if (loadingDepth <= 40)    loadingAsset = Assets.Interfaces.LOADING_CITY;
		else if (loadingDepth <= 50)    loadingAsset = Assets.Interfaces.LOADING_HALLS;
