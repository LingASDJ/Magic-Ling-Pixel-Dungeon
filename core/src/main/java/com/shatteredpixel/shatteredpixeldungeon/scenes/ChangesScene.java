...
public class ChangesScene extends PixelScene {
	...
	public void create() {
		...
		RedButton btn0_8 = new RedButton("MLPD"){
			@Override
		...
		if (changesSelected == 0) btn0_8.textColor(0x00FFFF);
		btn0_8.setRect(list.left()-4f, list.bottom()+5, 70, 14);
		add(btn0_8);

		RedButton btn0_7 = new RedButton("SPD"){
			@Override
			protected void onClick() {
				super.onClick();
		...
		if (changesSelected == 1) btn0_7.textColor(0x00FF00);
		btn0_7.setRect(btn0_8.right() + 1, btn0_8.top(), 70, 14);
		add(btn0_7);
