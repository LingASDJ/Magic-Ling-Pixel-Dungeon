...
import com.shatteredpixel.shatteredpixeldungeon.ui.changelist.T_Changes;
	...
	public void create() {
		...
		switch (changesSelected){
			...
			case 1:
				...
				break;
			case 2:
				T_Changes.addAllChanges(changeInfos);
				break;
		}
		...
		StyledButton btn0_9 = new StyledButton(Chrome.Type.GREY_BUTTON_TR, "MLPD"){
			@Override
		...
		if (changesSelected != 0) btn0_9.textColor( 0x00FFFF );
		btn0_9.setRect(list.left()-4f, list.bottom(), 35, changesSelected == 0 ? 19 : 15);
		addToBack(btn0_9);

		StyledButton btn0_8 = new StyledButton(Chrome.Type.GREY_BUTTON_TR, "SHPD"){
			@Override
			protected void onClick() {
				super.onClick();
		...
		if (changesSelected != 1) btn0_8.textColor( 0x00FF00 );
		btn0_8.setRect(btn0_9.right() + 1, list.bottom(), 70, changesSelected == 1 ? 19 : 15);
		addToBack(btn0_8);

		StyledButton btn0_7 = new StyledButton(Chrome.Type.GREY_BUTTON_TR, "MLOG"){
			@Override
			protected void onClick() {
				super.onClick();
		...
		if (changesSelected != 2) btn0_7.textColor( 0xFF00FF );
		btn0_7.setRect(btn0_8.right() + 1, btn0_8.top(), 34, changesSelected == 2 ? 19 : 15);
		addToBack(btn0_7);
