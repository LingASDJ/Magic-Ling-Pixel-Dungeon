...
public class GameScene extends PixelScene {
	...
	public void create() {
		...
		case DESCEND:
			...
			case 0:
				WndStory.showChapter( WndStory.ID_WORLD );
				break;
			case 1:
				WndStory.showChapter( WndStory.ID_SEWERS );
				break;
			case 5:
				WndStory.showChapter( WndStory.N1);
				break;
			case 6:
				WndStory.showChapter( WndStory.ID_PRISON );
				break;
			case 10:
				WndStory.showChapter( WndStory.N2 );
				break;
			case 11:
				WndStory.showChapter( WndStory.ID_CAVES );
				break;
			case 15:
				WndStory.showChapter( WndStory.N3);
				break;
			case 16:
				WndStory.showChapter( WndStory.ID_CITY );
				break;
			case 20:
				WndStory.showChapter( WndStory.N4);
				break;
			case 21:
				WndStory.showChapter( WndStory.ID_HALLS);
				break;
				case 25:
					WndStory.showChapter( WndStory.N5);
					break;
				case 26:
					WndStory.showChapter( WndStory.NEW);
					break;
			}
