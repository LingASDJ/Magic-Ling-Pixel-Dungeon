...
public class AboutScene extends PixelScene {
	...
	public void create() {
		...
		CreditsBlock shpx = new CreditsBlock(true, Window.SHPX_COLOR,
				"Shattered Pixel Dungeon V0.8.1b"+
						"\nMagic Ling Pixel Dungeon V0.4.8.0",
				Icons.SHPX.get(),
				"MLPD Developed By:_JDSA Ling_\nBase on SPD Source\nSPD Developed by: _Evan " +
						"Debenham_\nBased on " +
						"Pixel " +
						"Dungeon's open source",
				"加入QQ群聊",
				"https://jq.qq.com/?_wv=1027&k=XqhIBvOW");
		...
		final int GDX_COLOR = 0xFF00FF;
		CreditsBlock gdx = new CreditsBlock(true,
				GDX_COLOR,
				null,
				Icons.GOLD.get(),
				"Magic Ling Pixel Dungeon",
				"CLick below Link get My Project Source\n                  点击我获取源代码",
				"https://github.com/LingASDJ/Magic-Ling-Pixel-Dungeon/tree/master");
		if (landscape()){
		...
		CreditsBlock transifex = new CreditsBlock(true,
				...
				null,
				null,
				"如果你要对我的语言进行翻译，请联系我！给我发电子邮件！\n_CutelinXXX@126.com_",
				"或者在QQ群上联系我",
				"https://jq.qq.com/?_wv=1027&k=XqhIBvOW");
		...
		CreditsBlock freesound = new CreditsBlock(true,
				...
				null,
				null,
				"Magic Ling Pixel Dungeon Used the following _Projecct_\n魔绫的像素地牢使用了以下工程的源代码:\n\n" +
				...
				"以下工程是_闭源工程_ 通过MT转_JAR_导入\n\nThe following projects are _closed source_ projects " +
						"are imported via MT to _JAR_\n\n\n"+
