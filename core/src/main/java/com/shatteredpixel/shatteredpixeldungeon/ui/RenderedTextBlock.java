...
public class RenderedTextBlock extends Component {
	...
	private int RColor = Window.R_COLOR;
	private int GColor = Window.G_COLOR;
	private int BColor = Window.B_COLOR;
	...
	private synchronized void build(){
		...
		boolean Rhighlighting = false;
		boolean Ghighlighting = false;
		boolean Bhighlighting = false;
		for (String str : tokens){

			if (str.equals("_") && highlightingEnabled){
				highlighting = !highlighting;
			} else if(str.equals("€") && REnabled){
				Rhighlighting = !Rhighlighting;
			} else if(str.equals("＄") && GEnabled){
				Ghighlighting = !Ghighlighting;
			} else if(str.equals("∮") && BEnabled){
				Bhighlighting = !Bhighlighting;
			} else if (str.equals("\n")){
				words.add(NEWLINE);
			} else if (str.equals(" ")) {
				words.add(SPACE);
				...
				else if (Rhighlighting) word.hardlight(RColor);
				else if (Ghighlighting) word.hardlight(GColor);
				else if (Bhighlighting) word.hardlight(BColor);
				word.scale.set(zoom);
