...
import com.shatteredpixel.shatteredpixeldungeon.levels.ReloadLevel;
...
public class Dungeon {
	...
	public static boolean shopOnLevel() {
		return depth == 6 || depth == 11 || depth == 16|| depth == 21|| depth == 26|| depth == 31|| depth == 36;
	}
	...
	public static boolean bossLevel( int depth ) {
		return depth == 5 ||depth == 10 || depth == 20 || depth == 30 || depth == 40 || depth == 50;
	}
