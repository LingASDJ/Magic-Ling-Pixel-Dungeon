...
public enum Languages {
	...
	CHINESE("Englsih",         "en", Status.INCOMPLETE, new String[]{"JDSA-LING"}, null),
	JAPANESE("日本語",         "jp", Status.CD, new String[]{"JDSA-LING"}, null),
	FTZW("繁体中文",         "ft", Status.KS, new String[]{"JDSA-LING"}, new String[]{"冷群怪"});
	public enum Status{
