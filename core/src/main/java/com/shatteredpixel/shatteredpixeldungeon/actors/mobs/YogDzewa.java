...
public class YogDzewa extends Mob {
	...
	public void aggro(Char ch) {
		for (Mob mob : (Iterable<Mob>)Dungeon.level.mobs.clone()) {
			if (Dungeon.level.distance(pos, mob.pos) <= 4 &&
					(mob instanceof Larva || mob instanceof RipperDemon|| mob instanceof MolotovHuntsman|| mob instanceof ShieldHuntsman)) {
					mob.aggro(ch);
			}
		}
	}
	...
	public void die( Object cause ) {
		...
		for (Mob mob : (Iterable<Mob>)Dungeon.level.mobs.clone()) {
			if (mob instanceof Larva || mob instanceof RipperDemon|| mob instanceof MolotovHuntsman|| mob instanceof ShieldHuntsman) {
				mob.die( cause );
			}
		}
